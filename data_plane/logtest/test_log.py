...
structlog.configure(logger_factory=LoggerFactory(), processors=[structlog.processors.JSONRenderer(indent=1, sort_keys=True)])
...
# alternativamente alcuni campi che si ripetono possiamo specificarli una volta sola
