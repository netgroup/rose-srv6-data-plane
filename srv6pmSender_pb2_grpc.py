...
class SRv6PMSenderServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.startExperiment = channel.unary_unary(
        '/SRv6PMSenderService/startExperiment',
    ...
    self.stopExperiment = channel.unary_unary(
        '/SRv6PMSenderService/stopExperiment',
    ...
    self.retriveExperimentResults = channel.unary_unary(
        '/SRv6PMSenderService/retriveExperimentResults',
...
class SRv6PMSenderServiceServicer(object):
  # missing associated documentation comment in .proto file
  pass
...
def add_SRv6PMSenderServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'SRv6PMSenderService', rpc_method_handlers)
